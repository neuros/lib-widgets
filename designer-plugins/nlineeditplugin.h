#ifndef _NLINEEDITPLUGIN_H_
#define _NLINEEDITPLUGIN_H_
/*
 ...
 */
class NLineEditPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    /*
...
public:
    NLineEditPlugin(QObject *parent = NULL);
