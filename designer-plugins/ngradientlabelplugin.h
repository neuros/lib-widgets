#ifndef _NGRADIENTLABELPLUGIN_H_
#define _NGRADIENTLABELPLUGIN_H_
/*
 ...
 */
class NGradientLabelPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    /*
...
public:
    NGradientLabelPlugin(QObject *parent = 0);
...
#endif // _NGRADIENTLABELPLUGIN_H_
