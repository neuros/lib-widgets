...
NRibbonListViewPlugin::NRibbonListViewPlugin(QObject *parent)
 ...
 */
void NRibbonListViewPlugin::initialize(QDesignerFormEditorInterface *formEditor)
{
    Q_UNUSED(formEditor);
    if (initialized)
        return;
 ...
 */
bool NRibbonListViewPlugin::isInitialized( ) const
{
    return initialized;
}
 ...
 */
QWidget *NRibbonListViewPlugin::createWidget(QWidget *parent)
{
    return new NRibbonListView(parent);
}
 ...
 */
QString NRibbonListViewPlugin::name( ) const
{
    return "NRibbonListView";
}

/*
 * Returns the name of the group to which the custom widget belongs.
 */
QString NRibbonListViewPlugin::group( ) const
{
    return "Neux";
}
 ...
 */
QIcon NRibbonListViewPlugin::icon( ) const
{
    return QIcon( );
}
 ...
 */
QString NRibbonListViewPlugin::toolTip( ) const
{
    return "";
}
 ...
 */
QString NRibbonListViewPlugin::whatsThis( ) const
{
    return "";
}
 ...
 */
QString NRibbonListViewPlugin::includeFile( ) const
{
    return "nribbonlistview.h";
}

/*
 * True if the widget will be used to hold child widgets; otherwise false.
 */
bool NRibbonListViewPlugin::isContainer( ) const
{
    return false;
}
 ...
 */
QString NRibbonListViewPlugin::domXml( ) const
{
    return "<widget class=\"NRibbonListView\" name=\"ribbonListView\"> </widget>\n";
}
