#ifndef _NLISTVIEWPLUGIN_H_
#define _NLISTVIEWPLUGIN_H_
/*
 ...
 */
class NListViewPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    /*
...
public:
    NListViewPlugin(QObject *parent = NULL);
