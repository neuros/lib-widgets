#ifndef _NPUSHBUTTONPLUGIN_H_
#define _NPUSHBUTTONPLUGIN_H_
/*
 ...
 */
class NPushButtonPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    /*
...
public:
    NPushButtonPlugin(QObject *parent = NULL);
