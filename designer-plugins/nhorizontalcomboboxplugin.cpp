 ...
 ****************************************************************************
 *
 * NHorizontalComboBoxPlugin source
 *
 * REVISION:
 * 
...
NHorizontalComboBoxPlugin::NHorizontalComboBoxPlugin(QObject *parent)
 ...
 */
void NHorizontalComboBoxPlugin::initialize(QDesignerFormEditorInterface *formEditor)
{
    Q_UNUSED(formEditor);
    if (initialized)
        return;
 ...
 */
bool NHorizontalComboBoxPlugin::isInitialized( ) const
{
    return initialized;
}
 ...
 */
QWidget *NHorizontalComboBoxPlugin::createWidget(QWidget *parent)
{
    return new NHorizontalComboBox(parent);
}
 ...
 */
QString NHorizontalComboBoxPlugin::name( ) const
{
    return "NHorizontalComboBox";
}

/*
 * Returns the name of the group to which the custom widget belongs.
 */
QString NHorizontalComboBoxPlugin::group( ) const
{
    return "Neux";
}
 ...
 */
QIcon NHorizontalComboBoxPlugin::icon( ) const
{
    return QIcon( );
}
 ...
 */
QString NHorizontalComboBoxPlugin::toolTip( ) const
{
    return "";
}
 ...
 */
QString NHorizontalComboBoxPlugin::whatsThis( ) const
{
    return "";
}
 ...
 */
QString NHorizontalComboBoxPlugin::includeFile( ) const
{
    return "nhorizontalcombobox.h";
}

/*
 * True if the widget will be used to hold child widgets; otherwise false.
 */
bool NHorizontalComboBoxPlugin::isContainer( ) const
{
    return false;
}
 ...
 */
QString NHorizontalComboBoxPlugin::domXml( ) const
{
    return "<widget class=\"NHorizontalComboBox\" name=\"horizontalComboBox\"> </widget>\n";
}
