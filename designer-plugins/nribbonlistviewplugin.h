#ifndef _NRIBBONLISTVIEWPLUGIN_H_
#define _NRIBBONLISTVIEWPLUGIN_H_
/*
 ...
 */
class NRibbonListViewPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    /*
...
public:
    NRibbonListViewPlugin(QObject *parent = NULL);
...
#endif // _NRIBBONLISTVIEWPLUGIN_H_
