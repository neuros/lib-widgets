#ifndef _NTIMEPROGRESSBARPLUGIN_H_
#define _NTIMEPROGRESSBARPLUGIN_H_
/*
 ...
 */
class NTimeProgressBarPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    /*
...
public:
    NTimeProgressBarPlugin(QObject *parent = NULL);
...
#endif // _NTIMEPROGRESSBARPLUGIN_H_
