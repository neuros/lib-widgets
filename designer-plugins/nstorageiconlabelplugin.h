#ifndef _NSTORAGEICONLABELPLUGIN_H_
#define _NSTORAGEICONLABELPLUGIN_H_
/*
 ...
 ****************************************************************************
 *
 * NStorageIconLabelPlugin header
 *
 * REVISION:
 * 
 ...
 */
class NStorageIconLabelPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    /*
...
public:
    NStorageIconLabelPlugin(QObject *parent = NULL);
...
#endif // _NSTORAGEICONLABELPLUGIN_H_
