#ifndef _NSCROLLLABELPLUGIN_H_
#define _NSCROLLLABELPLUGIN_H_
/*
 ...
 */
class NScrollLabelPlugin : public QObject, public QDesignerCustomWidgetInterface
{
    /*
...
public:
    NScrollLabelPlugin(QObject *parent = NULL);
