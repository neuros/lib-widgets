...
#include "nscrolllabelplugin.h"
#include <QtPlugin>

NScrollLabelPlugin::NScrollLabelPlugin(QObject *parent)
 ...
 */
void NScrollLabelPlugin::initialize(QDesignerFormEditorInterface *formEditor)
{
    Q_UNUSED(formEditor);
    if (initialized)
        return;
 ...
 */
bool NScrollLabelPlugin::isInitialized( ) const
{
    return initialized;
}
 ...
 */
QWidget *NScrollLabelPlugin::createWidget(QWidget *parent)
{
    return new NScrollLabel(parent);
}
 ...
 */
QString NScrollLabelPlugin::name( ) const
{
    return "NScrollLabel";
}
 ...
 */
QString NScrollLabelPlugin::group( ) const
{
    return "Neux";
}
 ...
 */
QIcon NScrollLabelPlugin::icon( ) const
{
    return QIcon( );
}
 ...
 */
QString NScrollLabelPlugin::toolTip( ) const
{
    return "";
}
 ...
 */
QString NScrollLabelPlugin::whatsThis( ) const
{
    return "";
}
 ...
 */
QString NScrollLabelPlugin::includeFile( ) const
{
    return "nscrolllabel.h";
}

/*
 * True if the widget will be used to hold child widgets; otherwise false.
 */
bool NScrollLabelPlugin::isContainer( ) const
{
    return false;
}
 ...
 */
QString NScrollLabelPlugin::domXml( ) const
{
    return "<widget class=\"NScrollLabel\" name=\"label\"> </widget>\n";
}
